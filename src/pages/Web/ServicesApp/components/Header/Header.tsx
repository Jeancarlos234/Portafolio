    ...
    activeView: string
    onViewChange: (view: 'services' | 'detail' | 'request' | 'dashboard' | 'admin' | 'clients') => void
    }

    const Header = ({ activeView, onViewChange }: HeaderProps) => {
    const navItems = [
        { view: 'services' as const, label: 'Servicios', icon: (
    ...
    return (
        ...
        <div className={styles.container}>
            <div className={styles.logo} onClick={() => onViewChange('services')} style={{ cursor: 'pointer' }}>
            <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/>
            </svg>
            <span className={styles.logoText}>Service<span className={styles.highlight}>Hub</span></span>
            </div>
