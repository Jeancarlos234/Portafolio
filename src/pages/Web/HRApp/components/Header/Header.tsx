    ...
    activeView: string
    onViewChange: (view: 'dashboard' | 'employees' | 'add' | 'attendance' | 'vacations' | 'calendar' | 'history' | 'payroll' | 'documents' | 'performance' | 'reports') => void
    }
    ...
    const navItems = [
        ...
        { view: 'employees' as const, label: 'Empleados', icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
        )},
        { view: 'attendance' as const, label: 'Asistencia', icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
        )},
        { view: 'vacations' as const, label: 'Vacaciones', icon: (
        ...
        { view: 'payroll' as const, label: 'Nómina', icon: (
    ...
    return (
        ...
        <div className={styles.container}>
            ...
            <span className={styles.logoText}>HR<span className={styles.highlight}>Portal</span></span>
            </div>
