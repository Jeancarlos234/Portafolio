    ...
    const contactDetails = [
        {
            ...
            href: '/*',
            isExternal: false // No necesita target="_blank"
        },
        {
            icon: (
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            href: 'https://wa.me/593959734932?text=Hola%20Jean%20Carlos,%20vi%20tu%20portafolio%20y%20me%20gustaría%20contactarte' // WhatsApp con mensaje predeterminado
        },
        {
            icon: (
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            href: 'https://www.google.com/maps/place/Guayaquil,+Ecuador' // Google Maps
        }
    ]
    ...
    {
        label: 'Instagram',
        url: 'https://www.instagram.com/antaresjb22/',
        icon: (
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
